...
void MasterPathHandlers::HandleApiTableEndpoint(const Webserver::WebRequest& req,
...
void MasterPathHandlers::HandleApiTablesEndpoint(const Webserver::WebRequest& req,
                                                 Webserver::PrerenderedWebResponse* resp) {
  ostringstream* output = &resp->output;
...
void MasterPathHandlers::HandleGetTables(std::ostringstream* output, HttpStatusCode* status_code) {
...
void MasterPathHandlers::HandlePostTables(std::ostringstream* output,
...
void MasterPathHandlers::HandleGetTable(std::ostringstream* output,
                                        const Webserver::WebRequest& req,
                                        HttpStatusCode* status_code) {
  string table_id = req.path_params.at("table_id");
...
void MasterPathHandlers::HandlePutTable(std::ostringstream* output,
                                        const Webserver::WebRequest& req,
                                        HttpStatusCode* status_code) {
  string table_id = req.path_params.at("table_id");
...
void MasterPathHandlers::HandleDeleteTable(std::ostringstream* output,
                                           const Webserver::WebRequest& req,
                                           HttpStatusCode* status_code) {
  string table_id = req.path_params.at("table_id");
...
void MasterPathHandlers::PrintTableObject(std::ostringstream* output, const string& table_id) {
  scoped_refptr<TableInfo> table;
  Status status = master_->catalog_manager()->GetTableInfo(table_id, &table);
  JsonWriter jw(output, JsonWriter::COMPACT);
