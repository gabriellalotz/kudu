...
class CatalogManagerTest : public KuduTest {
 protected:
  void SetUp() override {
    KuduTest::SetUp();
  ...
  void CreateTableTest(CreateTableRequestPB& req, CreateTableResponsePB& resp) {
...
TEST_F(CatalogManagerTest, TestDeleteTable) {
  CreateTestTable();
...
TEST_F(CatalogManagerTest, TestDeleteTableWithUser) {
  CreateTestTable();
  DeleteTableRequestPB req;
  DeleteTableResponsePB resp;
  req.mutable_table()->set_table_name("test_table");
...
TEST_F(CatalogManagerTest, TestCreateTableRpc) {
  CreateTableRequestPB req;
  CreateTableResponsePB resp;
  CreateTableTest(req, resp);
  CatalogManager::ScopedLeaderSharedLock l(master_->catalog_manager());
...
TEST_F(CatalogManagerTest, TestAlterTableRpc) {
  CreateTestTable();
...
TEST_F(CatalogManagerTest, TestAlterTableWithUser) {
  CreateTestTable();
  AlterTableRequestPB req;
  AlterTableResponsePB resp;
